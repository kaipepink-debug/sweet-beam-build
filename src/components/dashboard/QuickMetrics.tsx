    ...
    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
      {metrics.map((m) => {
        ...
        return (
          <div
            key={m.title}
            className="rounded-2xl border border-border bg-card p-4 relative overflow-hidden purple-hover-glow"
          >
            <div
              className="absolute top-0 right-0 w-20 h-20 rounded-full blur-3xl opacity-15 translate-x-4 -translate-y-4"
