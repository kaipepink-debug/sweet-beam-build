import { Activity, CreditCard, LayoutGrid, LineChart, Mail, Settings, ShoppingBag, Sparkles, Users2, Sun, Moon, Bell, LogOut, Image, KeyRound, Crosshair } from "lucide-react";
...
const menuItems = [
  ...
  { title: "Pixels", url: "/dashboard/pixels", icon: Crosshair, permKey: "analytics" },
