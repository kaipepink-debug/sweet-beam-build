...
export function DashboardSidebar() {
  ...
  return (
    <aside
      className="fixed left-0 top-0 bottom-0 w-[60px] hover:w-[220px] z-40 flex flex-col py-4 gap-1 transition-all duration-300 overflow-hidden group/sidebar border-r border-border bg-card shadow-sm"
    >
      {/* Logo */}
