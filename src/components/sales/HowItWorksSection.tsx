    ...
    <section className="relative py-12 md:py-16 px-3 md:px-4">
      <div className="max-w-3xl mx-auto">
        ...
        <div className="relative flex flex-col md:flex-row gap-6 md:gap-3 items-center justify-between">
          ...
          <svg
            className="hidden md:block absolute top-7 left-0 right-0 w-full pointer-events-none"
          ...
          {steps.map((step) => (
            <div
              key={step.num}
              className="relative flex-1 text-center z-10 purple-hover-glow rounded-xl p-3"
            >
              <div
