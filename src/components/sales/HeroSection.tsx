...
const floatingIcons = [
  ...
  { logo: heygenLogo, name: "Heygen", x: -420, y: 60, mobileX: -140, mobileY: -60, delay: 0 },
  { logo: soraLogo, name: "Sora", x: 440, y: 50, mobileX: 140, mobileY: 40, delay: 0 },
  { logo: claudeLogo, name: "Claude", x: -360, y: 160, mobileX: -110, mobileY: 260, delay: 0 },
  { logo: freepikLogo, name: "Freepik", x: 380, y: 180, mobileX: 110, mobileY: 290, delay: 0 },
];
...
const HeroSection = () => {
  ...
  return (
    <section id="hero" className="relative min-h-screen flex items-start md:items-center justify-center px-3 md:px-4 overflow-hidden pt-28 md:pt-24">
