...
import { Copy, Eye, Download, KeyRound, ExternalLink, AlertTriangle, CheckCircle2, ArrowLeft } from "lucide-react";
...
const TOTP_SECRET = "UGOXHQROOAWTC6EPG4FT7WHN66RZJAQI";
      ...
      >
        ...
        <div className="rounded-2xl p-5 space-y-3" style={glassStyle}>
          ...
          <p className="text-sm text-muted-foreground pl-9">
            Faça o download do navegador oficial para acessar o painel.
          </p>
          <a
            href="https://dicloak.com/pt/download"
            target="_blank"
        ...
        <div className="rounded-2xl p-5 space-y-3" style={glassStyle}>
          ...
          <p className="text-sm text-muted-foreground pl-9">
            Com o programa aberto, use as credenciais abaixo:
          </p>
          <div className="space-y-2 pl-9">
            <CredentialRow label="Usuário" value="rataria.io" onCopy={() => copyToClipboard("rataria.io", "Usuário")} />
        ...
        <div className="rounded-2xl p-5 space-y-4" style={glassStyle}>
          ...
          <p className="text-sm text-muted-foreground pl-9">
            O sistema irá solicitar um código de autenticação. Clique abaixo para revelar e copiar.
          </p>
          ...
          <div
            ...
            style={{
              background: "hsla(270, 100%, 50%, 0.08)",
              border: "1px solid hsla(270, 100%, 50%, 0.25)",
            }}
          >
    ...
    <div className="flex items-center gap-3">
      <div
        className={`w-7 h-7 rounded-full flex items-center justify-center text-xs font-bold shrink-0 ${
          icon === "check" ? "bg-green-500/20 text-green-400" : "bg-primary/20 text-primary"
        }`}
      >
