...
const PERMISSION_LABELS: Record<string, string> = {
  ...
  gerar_avisos: "Gerar Avisos",
  acesso_clientes: "Acesso Clientes",
  pixels: "Pixels",
  analytics: "Analytics",
  equipe: "Equipe",
  afiliados: "Afiliados",
      ...
      <div className="flex items-center justify-between">
        ...
        <div className="flex items-center gap-2">
          <Link
            ...
            className="flex items-center gap-2 border border-border bg-card text-foreground px-4 py-2 rounded-xl text-sm font-medium hover:bg-muted/50 transition-colors"
          >
                          ...
                          <div className="flex flex-wrap gap-1.5">
                            {Object.entries(PERMISSION_LABELS)
                              ...
                              .map(([, label]) => (
                                <span
                                  key={label}
                                  className="text-[10px] font-medium px-2 py-0.5 rounded-full bg-emerald-500/80 text-white border border-emerald-500/60"
                                >
                                  {label}
                                </span>
                              ))}
