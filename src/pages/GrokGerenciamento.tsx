...
import {
  ...
  ArrowUpDown, Filter, Check, Eye, EyeOff, ExternalLink
} from "lucide-react";
...
export default function GrokGerenciamento() {
          ...
          <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 mb-6">
            <div className="flex items-center gap-4">
              <div className="w-14 h-14 rounded-2xl bg-card border border-border flex items-center justify-center shadow-lg">
                <img src={grokLogo} alt="Grok" className="w-9 h-9 object-contain" />
              </div>
              <div>
                <h1 className="text-2xl font-bold text-foreground">SuperGrok</h1>
                      ...
                      <div className="flex items-center gap-2 shrink-0">
                        ...
                        {a.video_url && (
                          <Button
                            variant="ghost"
                            size="icon"
                            onClick={() => setVideoModal(a.video_url!)}
      ...
      <Dialog open={dialogOpen} onOpenChange={setDialogOpen}>
        <DialogContent className="sm:max-w-lg rounded-2xl">
          <DialogHeader>
            ...
            <DialogDescription>
              {editingId ? "Atualize os dados do acesso." : "Preencha os dados para criar um novo acesso GROK."}
            </DialogDescription>
          </DialogHeader>
              ...
              <div className="grid gap-2">
                ...
                <Popover>
                  ...
                  <PopoverContent className="w-auto p-0" align="start">
                    <Calendar
                      mode="single"
                      selected={form.data_criacao}
                      onSelect={d => d && setForm(f => ({ ...f, data_criacao: d }))}
              ...
              <div className="grid gap-2">
                ...
                <Popover>
                  ...
                  <PopoverContent className="w-auto p-0" align="start">
                    <Calendar
                      mode="single"
                      selected={form.data_expiracao}
                      onSelect={d => d && setForm(f => ({ ...f, data_expiracao: d }))}
                      className="p-3 pointer-events-auto"
                      locale={ptBR}
                    />
                  </PopoverContent>
